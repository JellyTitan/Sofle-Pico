...
This are the Cricut recommended tools and materials for cutting foam.
...
1. Browse materials:<br><img src="/images/cases/1_browse-all-materials.png" alt="Browsing materiels in the Cricut Design Space" width="100%">
2. <img src="/images/cases/2_select-foam.png" alt="Selecting the material 'foam' in the Cricut Design Space" width="100%">
3. <img src="/images/cases/3_select-craft-foam.png" alt="Selecting the subset from material 'foam' in the Cricut Design Space" width="100%">
4. <img src="/images/cases/4_deep-point-blade.png" alt="Selecting the blade to be used with the 'foam' setting in the Cricut Design Space" width="100%">
