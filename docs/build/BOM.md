...
| Resistors | 4 | Through-hole 2.2k resistors. Used as pull-up resistors on the I2C bus These are common, any old one should do. These are hard to find in small quantities, consider getting it as part of kit. |  [AliExpress](https://www.aliexpress.us/item/3256804747550699.html) <br> [Amazon](https://www.amazon.com/BOJACK-Values-Resistor-Resistors-Assortment/dp/B08FD1XVL6/?th=1)|
| Raspberry Pi Picos | 2 | PCB is specifically designed with the Official Pico and YD-2040 type clone in mind, however several [other clone types](https://docs.google.com/spreadsheets/d/1LPjy6F5lHfUkmsrM5zlZmc5auYy5YBakW8Awe6hYFWo) should be compatible (Waveshare, WeAct, EstarDyn). Although the Pico is designed with a surface mount option, the Sofle Pico is designed assuming the Pico is soldered with [headers](https://www.sparkfun.com/products/17907). The Official Pico uses Micro USB, which has been known to snap off. The USB-C variants are recommended. [Avoid 'Tenstar' clones, they have a pinout that is non-compliant with the official Pico](https://github.com/JellyTitan/Sofle-Pico/discussions/29#discussioncomment-10584762). | [AliExpress: YD-2040](https://www.aliexpress.us/item/3256803909832318.html), [Official Raspberry Pi Resellers](https://www.raspberrypi.com/products/raspberry-pi-pico/)|
