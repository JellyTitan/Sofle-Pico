...
- [Build Guide](#build-guide)
  ...
  - [Firmware and programming](#firmware-and-programming)
    - [To flash with 'drag 'n drop':](#to-flash-with-drag-n-drop)
    - [Flashing the second time around](#flashing-the-second-time-around)
    - [Compile your own firmware with QMK](#compile-your-own-firmware-with-qmk)
  - [VIA](#via)
