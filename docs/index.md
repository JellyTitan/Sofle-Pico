...
<picture >
  <source media="(prefers-color-scheme: dark)" srcset="images/logos/sofle-pico-logo-readme-lockup-darkmode.svg">
  <source media="(prefers-color-scheme: light)" srcset="images/logos/sofle-pico-logo-readme-lockup-lightmode.svg">
  <img width="100%" alt="Sofle Pico logo" src="images/logos/sofle-pico-logo-readme-lockup-lightmode.svg">
</picture>
...
The Sofle Pico was designed to be easily modified! Want to [contribute](contribute)?
...
- [Sofle Pico Split Keyboard    ](#sofle-pico-split-keyboard----)
  - [Punchlist before Sofle PR](#punchlist-before-sofle-pr)
  - [Punchlist before QMK PR](#punchlist-before-qmk-pr)
...
![Default layout for SofleKeyboard](images/readme/soflekeyboard.png)

## Version History
See the [build log](build-log).
